...
class eapearsonWidgetDemo6Test(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('eapearsonWidgetDemo6'):
    ...
    def test_your_method(self):
        ...
        ret = self.serviceImpl.run_eapearsonWidgetDemo6(self.ctx, {'workspace_name': self.wsName,
