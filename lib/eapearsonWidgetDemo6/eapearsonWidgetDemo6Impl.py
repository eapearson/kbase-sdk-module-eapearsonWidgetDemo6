...
class eapearsonWidgetDemo6:
    ...
    VERSION = "0.0.1"
    GIT_URL = ""
    GIT_COMMIT_HASH = "1d5f2c29d7ee11b702992c9a5583700065f7292d"
    ...
    def run_eapearsonWidgetDemo6(self, ctx, params):
        """
        ...
        #BEGIN run_eapearsonWidgetDemo6
        ...
        #END run_eapearsonWidgetDemo6

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_eapearsonWidgetDemo6 return value ' +
